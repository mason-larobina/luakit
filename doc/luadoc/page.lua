...
--- Wrap a JavaScript function as a Lua function.
--
-- @method wrap_js
-- @tparam string script The JavaScript code which will be evaluated. The last
-- value generated by the script must be the function to be wrapped. Example:
--
--     local example = page:wrap_js([=[
